...
define("RELATIVE_PATH", [
    "controllers" => "http://localhost/sites/tanguygames/www/" . "controllers/",
    ...
    //"root" => ABSOLUTE_PATH,
    "root" => "http://localhost/sites/tanguygames/www/",
]);
...
{
    return '<svg class="icons i_' . $dimensions . '" role="img"><use xlink:href="' . RELATIVE_PATH['root'] . 'css/icons/fonts-defs.svg#' . $name . '"></use></svg>';
}
